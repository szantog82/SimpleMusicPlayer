...
public class MainActivity3 extends AppCompatActivity implements PlaybackService.PlaybackListener, AdapterView.OnItemClickListener, View.OnClickListener, SeekBar.OnSeekBarChangeListener, ListFilesAdapter.OnFileCheckedChangeListener {
    ...
    ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            if (service != null) {
                service.setPlaybackListener(MainActivity3.this);
            }
        }
